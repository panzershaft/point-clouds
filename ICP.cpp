...
void ICP::colour_time(PointCloudT::Ptr cloud_filtered_two,
    ...
    viewer.addPointCloud(cloud_filtered_one, source_cloud_color_handler, "target cloud");
...
int ICP::file_loader() {
  ...
  ICP::colour_time(cloud_filtered_one, cloud_icp);
